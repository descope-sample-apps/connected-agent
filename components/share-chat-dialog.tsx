...
export default function ShareChatDialog({ isOpen, onClose, chatId }: ShareChatDialogProps) {
  const [copied, setCopied] = useState(false)
  const [allowComments, setAllowComments] = useState(false)
  const [isPublic, setIsPublic] = useState(true)

  // In a real app, this would be generated on the server
  const shareUrl = `https://sales-assistant.app/shared/${chatId}`
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">Create a shareable link to this conversation</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button type="button" size="icon" variant="outline" onClick={copyToClipboard} className="shrink-0">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Let viewers add comments to the shared chat</p>
              </div>
